...
export default function NewProposalPage() {
  ...
  return (
    <div className="container mx-auto py-6 space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-[#0c2d6b]">Submit New Proposal</h1>
        <p className="text-muted-foreground">Fill out the form below to submit your event or project proposal</p>
      </div>
